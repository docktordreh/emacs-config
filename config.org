...
(setq org-latex-pdf-process
      '("LC_ALL=en_US.UTF-8 lualatex -shell-escape -interaction nonstopmode %f"
        "LC_ALL=en_US.UTF-8 lualatex -shell-escape -interaction nonstopmode %f"))
#+end_src
...
(setenv "LD_PRELOAD" (concat "/lib/libstdc++.so.6:" (getenv "LD_PRELOAD")))
(setq matlab-shell-command "/home/valentin/matlab/bin/matlab")
(setq matlab-shell-command-switches (list "-nodesktop"))
(add-hook! 'matlab-mode #'mlint-minor-mode)
#+end_src
